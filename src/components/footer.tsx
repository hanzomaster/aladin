      ...
      <footer className="bg-[#eff6ff] text-center text-gray-600 lg:text-left">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          ...
          ">
                ...
                Aladin ECOMMERCE SHOP
              </h6>
              <p>Thứ gì bạn cần, chúng tôi đều có, đủ cả bốn mùa, Xuân, Hạ, Thu, Đông.</p>
            </div>
            <div className="">
            ...
            <div className="">
              ...
              <a href="https://goo.gl/maps/BLwiPiHHzmT3p27h8" target="_blank" rel="noreferrer">
